...
-(void)awakeFromNib
{
	...
	[self setThumbImage:[UIImage imageWithContentsOfFile:@"/var/mobile/Whited00r/resources/switchThumb.png"] forState:UIControlStateNormal];
	[self setMinimumTrackImage:[UIImage imageWithContentsOfFile:@"/var/mobile/Whited00r/resources/switchBlueBg.png"] forState:UIControlStateNormal];
	[self setMaximumTrackImage:[UIImage imageWithContentsOfFile:@"/var/mobile/Whited00r/resources/switchOffPlain.png"] forState:UIControlStateNormal];
	...
	self.clippingView = [[UIView alloc] initWithFrame:CGRectMake(4,2,self.frame.size.width - 8,self.frame.size.height - 4)];
...
-(void)setTintColor:(UIColor*)color
{
	if (color != tintColor)
	{
		...
		[self setMinimumTrackImage:[self image:[UIImage imageWithContentsOfFile:@"/var/mobile/Whited00r/resources/switchBlueBg.png"] tintedWithColor:tintColor] forState:UIControlStateNormal];
	}
